package me.korinku.mofr.content.entities.frogs.apple;
...
public class AppleFrogEntity extends FrogEntity {

	public AppleFrogEntity(EntityType<? extends AnimalEntity> entityType, World world) {
		...
		if (ticks > 100) {
			...
			if (rnd < 50) {
				itemEntity = new ItemEntity(world, this.getX(), this.getY(),
						this.getZ(), new ItemStack(Items.APPLE, 1));
				itemEntity.setPickupDelay(30);
			} else {
				itemEntity = new ItemEntity(world, this.getX(), this.getY(),
						this.getZ(), new ItemStack(Items.GOLD_INGOT, 8));
				itemEntity.setPickupDelay(30);
			}
	...
	class FrogLookControl
		...
		protected boolean shouldStayHorizontal() {
			return AppleFrogEntity.this.getFrogTarget().isEmpty();
		}
	}
