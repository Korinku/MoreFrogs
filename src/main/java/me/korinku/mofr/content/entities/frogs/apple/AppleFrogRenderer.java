...
public class AppleFrogRenderer extends MobEntityRenderer<FrogEntity, FrogEntityModel<FrogEntity>> {

	private static final Identifier TEXTURE = new Identifier(MoreFrogs.MOD_ID,
			"textures/entity/frog/apple_frog.png");

	public AppleFrogRenderer(EntityRendererFactory.Context context) {
